...
export function Survey() {
  ...
  const sendForm = async () => {
    console.log(phone);
    try {
      await axios.post('http://localhost:5500/api/tasks', {
        name,
        phone,
        email,
        survey,
    ...
    <>
      ...
      <div className='main'>
        <div className={num === 1 ? 'container container-1' : 'container '}>
          ...
          <div className='survey-inputs'>
            <input
              ...
              name='Name'
              id='name'
              placeholder={failNAme ? 'Enter your Name' : 'Your Name'}
              value={name}
            ...
            <input
              ...
              id='phone'
              placeholder={
                failPhone ? 'Enter your Phone Number' : 'Your Phone Number'
              }
            ...
            <input
              ...
              name='Email'
              id='email'
              placeholder={failEmail ? 'Enter your Email' : 'Your Email'}
        ...
        <div className={num === 3 ? 'container container-3' : 'container '}>
          ...
          <div className='survey-inputs'>
            ...
            <label htmlFor='highly'>
              <div className='survey-options'> Highly satisfied</div>
            </label>
            <br />
            <input
              type='radio'
            ...
            <label htmlFor='not-so'>
              <div className='survey-options'> Not so satisfied</div>
            </label>
            <br />
            <input
              type='radio'
            ...
            <label htmlFor='not-at-all'>
              <div className='survey-options'> Not satisfied at all</div>
            </label>
          </div>
          <div className='survey-buttons'>
            <div className='previous'>
        ...
        <div className={num === 11 ? 'container container-11' : 'container'}>
          ...
          <div className='survey-inputs'>
            <input
              className={failRef ? 'fail que1' : 'que1'}
              type='text'
              name='ref'
              id='ref'
        ...
        <div
          className={num === 12 ? 'container container-12' : 'container'}
        ></div>
      </div>
    </>
  );
